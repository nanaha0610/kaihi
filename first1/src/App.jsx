      ...
      <div className="price-box">
        ...
        <div className="price-row">
          ...
          <input
            type="number"
            value={prices["1年"]}
            onChange={(e) => handlePriceChange("1年", e.target.value)}
          />
        </div>
        ...
        <div className="price-row">
          ...
          <input
            type="number"
            value={prices["2年"]}
            onChange={(e) => handlePriceChange("2年", e.target.value)}
          />
        </div>
        ...
        <div className="price-row">
          ...
          <input
            type="number"
            value={prices["3年"]}
            onChange={(e) => handlePriceChange("3年", e.target.value)}
          />
        </div>
        ...
        <div className="price-row">
          ...
          <input
            type="number"
            value={prices["4年"]}
            onChange={(e) => handlePriceChange("4年", e.target.value)}
          />
        </div>
      </div>
